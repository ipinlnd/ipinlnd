        ...
        <RowContainer style={{ paddingBottom: "1%" }} alignItems="flex-start">
          ...
          <SharedComponents.RowItem>
            <Card color="#A3DEE2" height="290px">
              ...
              applications. Working almost as the sole developer on the project,
              I proposed lots of optimizations to the code which ended up
              improving the performance on both frontend and backend. <br />{" "}
              <br />
              • Maintaining and further development of the server and the
              website using ASP.NET and MVC <br />
              ...
              and ios <br />
              • Published app on google play and Appstor <br />• Working
              remotely
            </Card>
          </SharedComponents.RowItem>
        </RowContainer>
